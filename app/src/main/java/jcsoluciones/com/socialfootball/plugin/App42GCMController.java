...
public class App42GCMController {
	 ...
	 */
	@SuppressLint("NewApi")
	public static void getRegistrationId(Context context, String googleProjectNo, App42GCMListener callBack) {
	...
	public static void registeronGCM(final Context context,
			final String googleProjectNo, final GoogleCloudMessaging gcm, final App42GCMListener callback) {
